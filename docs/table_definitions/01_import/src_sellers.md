...
|---|---|
| **論理名** | 販売者マスタ |
| **物理名** | `ec-data-platform-2026.01_import.src_sellers` |
...
```
src_sellers.seller_id              ← src_order_items.seller_id                        （1:多）
src_sellers.seller_zip_code_prefix → src_geolocation.geolocation_zip_code_prefix（多:多）
```
