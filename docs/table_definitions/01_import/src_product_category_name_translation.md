# テーブル定義書：src_product_category_name_translation

| 項目 | 値 |
|---|---|
| **論理名** | 商品カテゴリ翻訳マスタ |
| **物理名** | `ec-data-platform-2026.01_import.src_product_category_name_translation` |
...
```
src_product_category_name_translation.product_category_name ← src_products.product_category_name（1:多）
```
