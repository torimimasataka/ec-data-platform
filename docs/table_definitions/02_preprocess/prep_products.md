# テーブル定義書：prep_products

| 項目 | 値 |
|---|---|
| **論理名** | 商品マスタ |
| **物理名** | `ec-data-platform-2026.02_preprocess.prep_products` |
...
```
prep_products.product_id          ← prep_order_items.product_id              （1:多）
prep_products.product_category_name → prep_product_category_name_translation.product_category_name（多:1）
```
