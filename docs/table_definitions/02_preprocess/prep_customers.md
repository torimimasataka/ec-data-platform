# テーブル定義書：prep_customers

| 項目 | 値 |
|---|---|
| **論理名** | 顧客情報 |
| **物理名** | `ec-data-platform-2026.02_preprocess.prep_customers` |
...
```
prep_customers.customer_id          ← prep_orders.customer_id              （1:1）
prep_customers.customer_zip_code_prefix → prep_geolocation.geolocation_zip_code_prefix（多:多）
```
